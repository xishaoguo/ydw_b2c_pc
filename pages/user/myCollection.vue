      ...
      <div class="shopping-product">
        <div v-for="(productObj,index) in productInfo" :key="index" class="product-item">
          ...
          <div class="width140 product-btn">
            ...
            <span class="font-px14 color-999" @click="getCollectionDelete(productObj.productId)">取消收藏</span>
          </div>
        </div>
      </div>
...
<script>
import { getCollectionInfo, getCollectionDelete } from '~/api/user';
export default {
